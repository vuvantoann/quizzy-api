...
const routesV1 = (app) => {
    ...
    app.use(version + '/questions', authMiddleware.requireAuth, question_route_1.questionRoutes);
    app.use(version + '/users', user_route_1.userRoutes);
    app.use(version + '/topics', authMiddleware.requireAuth, topic_route_1.topicRoutes);
    app.use(version + '/answers', authMiddleware.requireAuth, answer_route_1.answerRoutes);
};
